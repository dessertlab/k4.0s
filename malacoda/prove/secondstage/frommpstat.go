...
func sampleCgroup(folder string) *stats_cgroup {
	...
	print(stats.cpupressure)
	// scanner := bufio.NewScanner(fp)
	// scanner.Scan()
	// fmt.Sscanf(scanner.Text(), "some avg10=%f avg60=%*f avg300=%*f total=%*d", &stats.cpupressure)
	// fp.Close()

	// fp, err = os.Open(folder + "/cpu.stat")
	// check(err)
	// scanner = bufio.NewScanner(fp)
	// scanner.Scan()
	// fmt.Sscanf(scanner.Text(), "some avg10=%f avg60=%*f avg300=%*f total=%*d", &stats.cpupressure)
	...
	// // scanner = bufio.NewScanner(fp)
	// // scanner.Scan()
	// // fmt.Sscanf(scanner.Text(), "some avg10=%f avg60=%*f avg300=%*f total=%*d", &stats.iopressure)
	// // fp.Close()
	...
	// // scanner = bufio.NewScanner(fp)
	// // scanner.Scan()
	// // fmt.Sscanf(scanner.Text(), "some avg10=%f avg60=%*f avg300=%*f total=%*d", &stats.mempressure)
	// // fp.Close()
