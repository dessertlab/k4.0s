...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&v1beta2.NodeAssuranceScorerArgs{}, func(obj interface{}) {
		SetObjectDefaults_NodeAssuranceScorerArgs(obj.(*v1beta2.NodeAssuranceScorerArgs))
	})
	...
	scheme.AddTypeDefaultingFunc(&v1beta2.TDMAschedulingArgs{}, func(obj interface{}) { SetObjectDefaults_TDMAschedulingArgs(obj.(*v1beta2.TDMAschedulingArgs)) })
...
func SetObjectDefaults_NodeAssuranceScorerArgs(in *v1beta2.NodeAssuranceScorerArgs) {
	SetDefaults_NodeAssuranceScorerArgs(in)
}
...
func SetObjectDefaults_TDMAschedulingArgs(in *v1beta2.TDMAschedulingArgs) {
	SetDefaults_TDMAschedulingArgs(in)
}
