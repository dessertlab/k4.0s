...
func SetDefaults_VolumeBindingArgs(obj *v1beta2.VolumeBindingArgs) {
	if obj.BindTimeoutSeconds == nil {
		obj.BindTimeoutSeconds = pointer.Int64Ptr(605)
	}
...
func SetDefaults_NodeAssuranceScorerArgs(obj *v1beta2.NodeAssuranceScorerArgs) {
	if obj.Mode == "" {
		obj.Mode = v1beta2.Most
	}
}

func SetDefaults_TDMAschedulingArgs(obj *v1beta2.TDMAschedulingArgs) {
	if obj.Master == "" {
