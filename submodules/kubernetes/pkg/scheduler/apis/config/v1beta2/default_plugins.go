...
func getDefaultPlugins() *v1beta2.Plugins {
	plugins := &v1beta2.Plugins{
		...
		Score: v1beta2.PluginSet{
			Enabled: []v1beta2.Plugin{
				{Name: names.Rtschedulability, Weight: pointer.Int32Ptr(1)},
				...
				//{Name: names.Coscheduling, Weight: pointer.Int32Ptr(1)},
				{Name: names.NodeAssuranceScorer, Weight: pointer.Int32Ptr(1)},
			},
		},
