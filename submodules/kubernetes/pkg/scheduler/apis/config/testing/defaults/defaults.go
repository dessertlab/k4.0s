...
var PluginsV1beta1 = &config.Plugins{
	...
	Score: config.PluginSet{
		Enabled: []config.Plugin{
			{Name: names.Rtschedulability, Weight: 1},
...
var PluginConfigsV1beta1 = []config.PluginConfig{
	...
	{
		Name: "NodeAssuranceScorer",
		Args: &config.NodeAssuranceScorerArgs{
			Mode: config.Most,
		},
	},
	{
		Name: "TDMAscheduling",
		Args: &config.TDMAschedulingArgs{
			Master: "192.168.1.1",
			Cycle:  5000,
			Port:   8889,
		},
...
var PluginsV1beta2 = &config.Plugins{
	...
	Score: config.PluginSet{
		Enabled: []config.Plugin{
			...
			{Name: names.PodTopologySpread, Weight: 2},
			{Name: names.TaintToleration, Weight: 1},
			//{Name: names.Coscheduling, Weight: 1},
		},
	},
	Reserve: config.PluginSet{
		Enabled: []config.Plugin{
