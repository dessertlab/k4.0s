...
func SetDefaults_VolumeBindingArgs(obj *v1beta1.VolumeBindingArgs) {
	if obj.BindTimeoutSeconds == nil {
		obj.BindTimeoutSeconds = pointer.Int64Ptr(601)
	}
...
func SetDefaults_NodeAssuranceScorerArgs(obj *v1beta1.NodeAssuranceScorerArgs) {
	if obj.Mode == "" {
		obj.Mode = v1beta1.Most
	}
}

func SetDefaults_TDMAschedulingArgs(obj *v1beta1.TDMAschedulingArgs) {
	if obj.Master == "" {
		obj.Master = "192.168.1.1"
	}
	if obj.Cycle == 0 {
		obj.Cycle = 5000
	}
