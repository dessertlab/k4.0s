...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.NodeAssuranceScorerArgs)(nil), (*config.NodeAssuranceScorerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NodeAssuranceScorerArgs_To_config_NodeAssuranceScorerArgs(a.(*v1beta1.NodeAssuranceScorerArgs), b.(*config.NodeAssuranceScorerArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeAssuranceScorerArgs)(nil), (*v1beta1.NodeAssuranceScorerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeAssuranceScorerArgs_To_v1beta1_NodeAssuranceScorerArgs(a.(*config.NodeAssuranceScorerArgs), b.(*v1beta1.NodeAssuranceScorerArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.TDMAschedulingArgs)(nil), (*config.TDMAschedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_TDMAschedulingArgs_To_config_TDMAschedulingArgs(a.(*v1beta1.TDMAschedulingArgs), b.(*config.TDMAschedulingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.TDMAschedulingArgs)(nil), (*v1beta1.TDMAschedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_TDMAschedulingArgs_To_v1beta1_TDMAschedulingArgs(a.(*config.TDMAschedulingArgs), b.(*v1beta1.TDMAschedulingArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NodeAssuranceScorerArgs_To_config_NodeAssuranceScorerArgs(in *v1beta1.NodeAssuranceScorerArgs, out *config.NodeAssuranceScorerArgs, s conversion.Scope) error {
	out.Mode = config.ModeType(in.Mode)
	return nil
}

// Convert_v1beta1_NodeAssuranceScorerArgs_To_config_NodeAssuranceScorerArgs is an autogenerated conversion function.
func Convert_v1beta1_NodeAssuranceScorerArgs_To_config_NodeAssuranceScorerArgs(in *v1beta1.NodeAssuranceScorerArgs, out *config.NodeAssuranceScorerArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NodeAssuranceScorerArgs_To_config_NodeAssuranceScorerArgs(in, out, s)
}

func autoConvert_config_NodeAssuranceScorerArgs_To_v1beta1_NodeAssuranceScorerArgs(in *config.NodeAssuranceScorerArgs, out *v1beta1.NodeAssuranceScorerArgs, s conversion.Scope) error {
	out.Mode = v1beta1.ModeType(in.Mode)
	return nil
}

// Convert_config_NodeAssuranceScorerArgs_To_v1beta1_NodeAssuranceScorerArgs is an autogenerated conversion function.
func Convert_config_NodeAssuranceScorerArgs_To_v1beta1_NodeAssuranceScorerArgs(in *config.NodeAssuranceScorerArgs, out *v1beta1.NodeAssuranceScorerArgs, s conversion.Scope) error {
	return autoConvert_config_NodeAssuranceScorerArgs_To_v1beta1_NodeAssuranceScorerArgs(in, out, s)
}
...
func autoConvert_v1beta1_TDMAschedulingArgs_To_config_TDMAschedulingArgs(in *v1beta1.TDMAschedulingArgs, out *config.TDMAschedulingArgs, s conversion.Scope) error {
...
// Convert_v1beta1_TDMAschedulingArgs_To_config_TDMAschedulingArgs is an autogenerated conversion function.
func Convert_v1beta1_TDMAschedulingArgs_To_config_TDMAschedulingArgs(in *v1beta1.TDMAschedulingArgs, out *config.TDMAschedulingArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_TDMAschedulingArgs_To_config_TDMAschedulingArgs(in, out, s)
}

func autoConvert_config_TDMAschedulingArgs_To_v1beta1_TDMAschedulingArgs(in *config.TDMAschedulingArgs, out *v1beta1.TDMAschedulingArgs, s conversion.Scope) error {
	out.Master = in.Master
	out.Port = in.Port
	out.Cycle = in.Cycle
	return nil
...
// Convert_config_TDMAschedulingArgs_To_v1beta1_TDMAschedulingArgs is an autogenerated conversion function.
func Convert_config_TDMAschedulingArgs_To_v1beta1_TDMAschedulingArgs(in *config.TDMAschedulingArgs, out *v1beta1.TDMAschedulingArgs, s conversion.Scope) error {
	return autoConvert_config_TDMAschedulingArgs_To_v1beta1_TDMAschedulingArgs(in, out, s)
}
