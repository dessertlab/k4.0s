...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&v1beta1.NodeAssuranceScorerArgs{}, func(obj interface{}) {
		SetObjectDefaults_NodeAssuranceScorerArgs(obj.(*v1beta1.NodeAssuranceScorerArgs))
	})
	...
	scheme.AddTypeDefaultingFunc(&v1beta1.TDMAschedulingArgs{}, func(obj interface{}) { SetObjectDefaults_TDMAschedulingArgs(obj.(*v1beta1.TDMAschedulingArgs)) })
...
func SetObjectDefaults_NodeAssuranceScorerArgs(in *v1beta1.NodeAssuranceScorerArgs) {
...
func SetObjectDefaults_TDMAschedulingArgs(in *v1beta1.TDMAschedulingArgs) {
